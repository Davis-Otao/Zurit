...
<div class="container d-flex align-items-stretch">
    ...
    <nav id="sidebar" class="img" style="background-image: url(admin_res/images/bg_1.jpg);">
        <div class="p-4">
            <a href="index.html"><img class="logo" src="admin_res/images/logo-white3.png" alt=""></a><span><br>Admin Dashboard</span>              
            <ul class="list-unstyled components mb-5 flex-container">
                ...
                <li>
                    <a href="#"><span class="fa fa-sticky-note mr-3"></span> System Insights</a>
                </li>
                <li>
