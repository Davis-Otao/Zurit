    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="mb-3">
                ...
                <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#addAssetModal">
                    Add New Asset
                </button>
                <!-- Trigger button for the liability modal -->
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#addLiabilityModal">
                    Add New Liability
                </button>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('storeAsset') }}" method="post" id="addAssetForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="" name="assetDescription" id="assetDescription" placeholder="Enter asset description">
                </div>
                <div class="form-group">
                    <label for="assetValue">Asset Value</label>
                    <input type="number" class="" name="assetValue" id="assetValue" placeholder="Enter asset value">
                </div>
...
<div class="modal fade" id="addLiabilityModal" tabindex="-1" role="dialog" aria-labelledby="addLiabilityModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('storeLiability') }}" method="post" id="addLiabilityForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="" id="liabilityDescription" name="liabilityDescription" placeholder="Enter liability description">
                </div>
                <div class="form-group">
                    <label for="liabilityValue">Liability Value</label>
                    <input type="number" class="" id="liabilityValue" name="liabilityValue" placeholder="Enter liability value">
                </div>
        ...
        <div<div class="card mt-3" style="background: linear-gradient(45deg, rgb(33, 150, 243), rgb(156, 39, 176), rgb(255, 193, 7)); color: #fff;">
            <div class="card-body">
                @php
            ...
            <div class="mt-4 text-center">
                ...
                <div style="max-width: 400px; margin: 20px auto; display: flex; flex-direction: column; align-items: center;">
...
tableRows.forEach(row => {
    ...
    assetValues.push(parseFloat(assetValue.innerText.replace('$', '').replace(/,/g, ''))); // Remove $ and commas, convert to float

    liabilityDescriptions.push(liabilityDescription.innerText);
    liabilityValues.push(parseFloat(liabilityValue.innerText.replace('$', '').replace(/,/g, ''))); // Remove $ and commas, convert to float
    ...
    data: {
        ...
        datasets: [
            ...
            },
            {
                ...
                borderWidth: 2,
                data: [liabilityValues.filter(Boolean).reduce((a, b) => a + b, 0)], // Total liabilities (negative for display purposes)
            },
        ],
    },
    options: {
            ...
            datasets: [
                {
                    data: [
                        ...
                        -liabilityValues.filter(Boolean).reduce((a, b) => a + b, 0), // Total liabilities
                    ],
